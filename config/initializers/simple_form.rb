...
SimpleForm.setup do |config|
  ...
  config.wrappers :basic, tag: false, :error_class => 'has-error' do |b|
    b.use :input
    b.use :error, :wrap_with => { :tag => 'span', :class => 'help-block error col-sm-5 col-offset3 inline' }
  end
  ...
  config.input_class = "col-sm-12 form-control"
